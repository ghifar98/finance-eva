<x-layouts.app :title="__('Account')">
                ...
                <div class="flex justify-between items-center">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-slate-600 font-medium">Manage your accounting structure</p>
                        </div>
                    </div>
                    ...
                    <nav class="flex items-center gap-2 text-sm text-slate-600">
                        ...
                        <span class="text-orange-600 font-medium">Accounts</span>
                    </nav>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                <div class="bg-white/90 backdrop-blur-lg rounded-2xl p-6 shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-slate-600 font-medium">Total Accounts</p>
                            <p class="text-3xl font-bold text-blue-700">{{ App\Models\Account::count() }}</p>
                        </div>
                ...
                <div class="bg-white/90 backdrop-blur-lg rounded-2xl p-6 shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-slate-600 font-medium">Total Debit</p>
                            <p class="text-2xl font-bold text-green-600">Rp {{ number_format(App\Models\Account::sum('debit'), 0, ',', '.') }}</p>
                        </div>
                ...
                <div class="bg-white/90 backdrop-blur-lg rounded-2xl p-6 shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-slate-600 font-medium">Total Credit</p>
                            <p class="text-2xl font-bold text-red-600">Rp {{ number_format(App\Models\Account::sum('credit'), 0, ',', '.') }}</p>
                        </div>
                ...
                <div class="bg-white/90 backdrop-blur-lg rounded-2xl p-6 shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-slate-600 font-medium">Net Balance</p>
                            <p class="text-2xl font-bold text-orange-600">Rp {{ number_format(App\Models\Account::sum('debit') - App\Models\Account::sum('credit'), 0, ',', '.') }}</p>
                        </div>
            ...
            <div class="bg-white/90 backdrop-blur-lg rounded-2xl p-6 shadow-lg border border-white/20 mb-8">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-slate-800">Account Management</h3>
                            <p class="text-slate-600">Create, edit, and manage your chart of accounts</p>
                        </div>
                    </div>
            ...
            <div class="flex items-center justify-center min-h-screen p-4">
                <div class="modal-content bg-white rounded-2xl p-8 max-w-md w-full mx-auto shadow-2xl transform transition-all duration-300 scale-95">
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-gray-600 mb-2">Apakah Anda yakin ingin menghapus akun:</p>
                        <p class="text-lg font-semibold text-gray-800 mb-4">"<span id="accountName"></span>"?</p>
    ...
    <script>
        ...
        function confirmDelete(accountId, accountName) {
            ...
            // Set the account name and form action
            accountNameSpan.textContent = accountName;
            deleteForm.action = `/account/${accountId}`;
