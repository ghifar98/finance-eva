...
<div class="flex min-h-screen">
    ...
    <div class="sidebar flex flex-col">
        ...
        <div class="flex flex-col flex-grow overflow-y-auto px-1 py-4">
            <!-- Dashboard - Available for Project Director and Project Manager -->
            ...
            <!-- Master Project - Available for Project Director and Project Manager -->
            @if (Auth::user()?->isRole('project_director') || Auth::user()?->isRole('project_manager'))
            ...
            <!-- RAB Proyek - Only for Project Manager -->
            @if (Auth::user()?->isRole('project_manager'))
            ...
            <!-- RAB Perminggu - Only for Project Manager -->
            @if (Auth::user()?->isRole('project_manager'))
            ...
            <!-- Account - Only for Finance Officer -->
            ...
            <!-- Purchase - Available for Finance Officer and Staff -->
            ...
            <!-- General Ledger - Only for Finance Officer -->
            @if (Auth::user()?->isRole('finance_officer'))
            ...
            <!-- Income Statement - Available for Project Director and Finance Officer -->
            ...
            <!-- EVA - Available for Project Director and Project Manager -->
            @if (Auth::user()?->isRole('project_director') || Auth::user()?->isRole('project_manager'))
            ...
            <!-- Role Indicator (Optional - for debugging/admin purposes) -->
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Navigation handling - MODIFIED TO FIX LOGOUT ISSUE
    ...
    // MODIFIED: Navigation click handler to exclude logout button
    document.addEventListener('click', function(e) {
        const navigationLink = e.target.closest('.navigation-link');
        const isLogoutButton = e.target.closest('#logout-form button');
        const isInDropdown = e.target.closest('#userDropdownMenu');
        
        // Skip if this is logout button or any button inside logout form
        if (isLogoutButton) {
            return; // Let the logout button handle its own click
        }
        
        if (navigationLink && !isInDropdown) {
            e.preventDefault();
    ...
    if (logoutButton) {
        ...
        logoutButton.addEventListener('click', function(e) {
            ...
            // The onclick attribute handles confirmation
            // Just ensure the event can proceed normally
        });
    ...
    document.addEventListener('submit', function(e) {
        ...
        // Skip processing for logout form
