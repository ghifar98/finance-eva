...
final class PurchaseTable extends PowerGridComponent
{
    ...
    match($model->status ?? 'belum disetujui') {
        'disetujui' => Blade::render('
        ...
        default => Blade::render('
            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-gradient-to-r from-yellow-100 to-yellow-200 text-yellow-800 border border-yellow-300">
                <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
