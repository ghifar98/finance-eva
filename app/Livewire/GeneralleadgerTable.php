...
final class GeneralleadgerTable extends PowerGridComponent
{
    ...
    public function fields(): PowerGridFields
    {
        return PowerGrid::fields()
            ...
            ->add('po_no')
            ->add('company')
            ->add('project_name', fn (Purchase $model) => $model->project->name ?? '-')
            ...
            ->add('qty')
            ->add('balance_formatted', fn (Purchase $model) => 'Rp ' . number_format($model->balance, 0, ',', '.'))
            ->add('total_ppn_formatted', fn (Purchase $model) => 'Rp ' . number_format($model->total_ppn, 0, ',', '.'))
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Vendor', 'vendor_name')
                ->sortable()
                ->searchable(),
            ...
            Column::make('Total Amount', 'total_amount_formatted', 'total_amount')
                ->sortable(),
